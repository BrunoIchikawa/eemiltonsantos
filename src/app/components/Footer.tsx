            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-4">
                  ...
                  <div className="text-sm text-blue-100">
                    {general.whatsapp && (
                      <a href={`https://wa.me/55${general.whatsapp.replace(/\D/g, '')}`} className="block hover:text-white transition-colors mb-3 font-medium">
                        {general.whatsapp} <span className="text-xs text-emerald-400 font-normal block mt-0.5">(WhatsApp)</span>
                      </a>
                    )}
                    {general.phone && (
                      <a href={`tel:${general.phone.replace(/\D/g, '')}`} className="block text-blue-200 hover:text-white transition-colors">
                        {general.phone} <span className="text-xs text-blue-300 font-normal block mt-0.5">(Apenas Ligação)</span>
                      </a>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 group">
                  ...
                  <div className="text-sm text-blue-100">
                    <a href={`mailto:${general.emailSecretaria}`} className="block hover:text-white transition-colors break-words">
                      {general.emailSecretaria}
                    </a>
                    <a href={`mailto:${general.emailDiretoria}`} className="block text-blue-200 hover:text-white transition-colors mt-1 break-words">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
              ...
              <div className="flex items-center gap-6">
                ...
                <button
                  ...
                  className="hidden md:flex text-blue-300 hover:text-white transition-colors items-center gap-1 text-xs px-2 py-1 rounded hover:bg-white/10"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-4 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0099DD] focus:border-transparent text-base"
